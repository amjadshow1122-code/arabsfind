      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <p>Al-Moavia Fragrance.com ("we", "us", "our") is an n fragrance sales aggregator. We are committed to protecting your personal information in accordance with the <em>Privacy Act 1988</em> (Cth) and the n Privacy Principles (APPs).</p>
            <div className="bg-gray-50 rounded-xl p-5 mt-4 text-sm space-y-1.5">
              <p className="flex items-center gap-2"><Mail size={14} className="text-secondary shrink-0" /> support@al-moavia fragrance.com</p>
              <p className="flex items-center gap-2"><MapPin size={14} className="text-secondary shrink-0" /> </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              <li>To provide and improve the Al-Moavia Fragrance.com platform</li>
          ...
          <section>
            ...
            <p className="mt-3">To exercise these rights, contact us at <a href="mailto:support@al-moavia fragrance.com" className="text-secondary hover:underline">support@al-moavia fragrance.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>For privacy enquiries or complaints, contact us at <a href="mailto:support@al-moavia fragrance.com" className="text-secondary hover:underline">support@al-moavia fragrance.com</a>. If you are unsatisfied, you may lodge a complaint with the <a href="https://www.oaic.gov/" target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline">Office of the n Information Commissioner (OAIC)</a>.</p>
          </section>
        </div>
      </motion.div>
    </div>
