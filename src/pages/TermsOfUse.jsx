      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>By accessing or using Al-Moavia Fragrance.com ("the Platform"), you agree to be bound by these Terms of Use. If you do not agree, please do not use the Platform. These terms are governed by the laws of New South Wales, .</p>
          </section>

          <section>
            <h2 className="text-xl font-heading font-bold text-primary mb-3">2. About the Platform</h2>
            <p>Al-Moavia Fragrance.com is an aggregator platform that lists fragrances, attars, and products sourced from global retailers. We are an independent third party and are not affiliated with, endorsed by, or acting as agents for any listed merchant.</p>
          </section>
          ...
          <section>
            ...
            <div className="bg-secondary/5 border border-secondary/20 rounded-xl p-5">
              ...
              <p>Al-Moavia Fragrance.com participates in affiliate programs. When you click a "Shop This Sale" or external link and make a purchase, we may receive a commission from the merchant at no additional cost to you. All outbound click-throughs are tracked through our redirect system for this purpose. This does not influence which sales are listed or how they are presented.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>For products sold directly on Al-Moavia Fragrance.com:</p>
            <ul className="list-disc pl-6 space-y-1.5 mt-3">
              <li>Payments are processed securely by Stripe. We never store card details.</li>
              <li>All prices are in n Dollars (AUD) and include GST where applicable.</li>
              <li>Orders are subject to availability. We reserve the right to cancel orders if stock is unavailable.</li>
              <li>Returns and refunds are handled in accordance with n Consumer Law.</li>
            </ul>
          ...
          <section>
            ...
            <p>To the maximum extent permitted by law, Al-Moavia Fragrance.com is not liable for any indirect, incidental, or consequential damages arising from your use of the platform, including losses from merchant transactions, inaccurate sale information, or third-party website issues.</p>
          </section>

          <section>
            <h2 className="text-xl font-heading font-bold text-primary mb-3">10. Intellectual Property</h2>
            <p>All platform content, design, code, and branding is the property of Al-Moavia Fragrance.com. Merchant names, logos, and product images remain the property of their respective owners and are used for identification purposes under nominative fair use.</p>
          </section>
          ...
          <section>
            ...
            <p>For legal enquiries: <a href="mailto:support@al-moavia fragrance.com" className="text-secondary hover:underline">support@al-moavia fragrance.com</a></p>
          </section>
        </div>
      </motion.div>
    </div>
